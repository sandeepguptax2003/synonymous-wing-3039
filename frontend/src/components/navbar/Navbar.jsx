  ...
  return (
    <>
      <div id="nav1">
        <a href="#">
          <h3>
            Score 50% off†† your favorite brands.
            <span className="hover-item-li">Shop Now ▸</span>
          | Free shipping on all orders. † Terms apply.{" "}
      ...
      <div id="nav2">
        <div>
          ...
          <div className="dropdown">
            ...
            <p>
              Stores & Services <br />
              <span className="nav2-sub-section">Choose Your Store</span>{" "}
            </p>
