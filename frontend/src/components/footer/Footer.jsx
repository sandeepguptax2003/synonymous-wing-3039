    ...
    <div className="footer-section-2">
        ...
        <div className="label-container">
            ...
            <div className="label-box">
                ...
                <div>
                    <span> Sign`S Credit Card Program
                    </span>
                    <p>Want 25% off your Sign`S purchase1? DETAILS</p>
                </div>
            </div>
        </div>
        <hr />
        <div className="details">
            <div>
                ...
                <p>News Room</p>
                <p>Career</p>
                <p> Sign`S Social Impact</p>
                <p> Supply Chain Transparency</p>
                <p> Affiliates</p>
                <p> Sign`S Events</p>
                <p> Gift Cards</p>
                <p> Sign`S Global Sites</p>
                <p> Diversity and Inclusion</p>
                <p> Checkout on Instagram</p>
                <p> Sign`S Accelerate</p>
            ...
            <div>
                ...
                <p> Sign`S at Kohl's</p>
                <p> Sign`S Inside JCPenney</p>
                <p> Store Locations</p>
                <p> Online Ordering</p>
                <p> Klarna</p>
                <p> Accessibility</p>
            ...
            <div className="footer-section-3">
                ...
                <div className="footer-section-box">
                    <div className="footer-section-sub-box">
                        ...
                        <label for="sign">Sign up for Sign`S Emails</label>
        ...
        <div className="footer-section-4">
            <div>
                <p>© 2022 Sign`S INDIA, Inc. All rights reserved.</p>
